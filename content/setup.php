<?php
/**
 * Demo site setup for Storstaden Bygg & Städservice AB.
 *
 ...
 *
 * @package Storstaden Bygg & Städservice AB
 */
 ...
 * Site settings
 * ----------------------------------------------------------------------- */
update_option( 'blogname', 'Storstaden Bygg & Städservice AB' );
...
$home = nps_page(
	...
	nps_pattern( 'storstadenbyggochstad/page-home' ),
...
nps_page(
	'takomlaggning',
	'Takomläggning',
	nps_pattern( 'storstadenbyggochstad/page-replacement' ),
...
nps_page(
	...
	nps_pattern( 'storstadenbyggochstad/page-storm' ),
...
$quote = nps_page(
	'offert',
	'Boka besiktning',
	nps_pattern( 'storstadenbyggochstad/quote-funnel' ),
...
$thanks = nps_page(
	'tack',
	'Tack',
	nps_pattern( 'storstadenbyggochstad/thank-you' ),
...
<p class="has-large-font-size">Storstaden Bygg & Städservice AB är ett familjeföretag från Sollentuna. Vi startade 1996 med en bil och en regel vi fortfarande håller oss till: priset vi skriver ner är priset du betalar.</p>
<!-- /wp:paragraph -->
...
<!-- /wp:list -->
HTML;
nps_page( 'om-oss', 'Om Storstaden Bygg & Städservice AB', $about_content . "\n\n" . nps_pattern( 'storstadenbyggochstad/cta-inline' ), 'Familjeägt takföretag i norra Stockholm sedan 1996. Egna montörer, fasta priser skriftligt och 10 års garanti.' );
...
nps_page( 'vanliga-fragor', 'Vanliga frågor', $faq_content . "\n\n" . nps_pattern( 'storstadenbyggochstad/cta-inline' ), 'Svar om offert, pris, ROT-avdrag, hur lång tid en takomläggning tar och vad garantin täcker.' );
...
<!-- /wp:paragraph -->
HTML;
$privacy = nps_page( 'integritetspolicy', 'Integritetspolicy', $privacy_content, 'Så använder Storstaden Bygg & Städservice AB uppgifterna du skickar med offertformuläret.' );
...
nps_log( 'Storstaden Bygg & Städservice AB demo ready.' );
